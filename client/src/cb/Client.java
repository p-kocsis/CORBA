...
public class Client extends CallBackPOA {
	public static void main(String[] args)  {
		...
		try {
			...
			//Callback fuer die Jacorbimplementation
			...
			//Die one_time funktion am server wird aufgerufen
			echo.one_time(ccb, "testnachricht");
			//Ist grundsaetzlich die gelcihe methode wie one_time nur mit zeitverzoegerungssimulator
			short period = 3;
			echo.register(ccb, "testnachricht", period);
			//Wird benoetigt damit sich der client nicht schliesst
			try {
				Thread.sleep(3000);
			} catch (Exception e) {
				e.printStackTrace();
